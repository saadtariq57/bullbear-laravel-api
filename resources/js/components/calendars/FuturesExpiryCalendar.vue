            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5 border-bottom">
                        <h1 class="fs-1 fw-bold icon-heading">Futures Expiry Calendar</h1>
                    </div>
                    <div class="expiry">
                            ...
                            <div class="calender_tabs">
                                ...
                                <div class="tab-content" id="myTabContent">
                                            ...
                                            <table class="table table-width border">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-start fw-6">Country</th>
                                                        <th class="text-start fw-6">Exchange Name</th>
                                                        <th class="text-start fw-6">Holiday</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-5">Jun 12, 2024</td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center "><img src="/build/images/flags/country_1.jpg" alt="flag"> USD</span></td>
                                                        <td class="text-start fw-5">Lagos</td>
                                                        <td class="text-start fw-5">Democracy Day</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-5">Jun 12, 2024</td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center "><img src="/build/images/flags/country_1.jpg" alt="flag"> USD</span></td>
                                        ...
                                        <div class=" overflow-auto market-table-wapper">
                                            <table class="table table-width border">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="fw-5"></td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center "><img src="/build/images/flags/country_2.jpg" alt="flag"> Philippines</span></td>
                                                        <td class="text-start fw-5">Philippines Stock Exchange</td>
                                                        <td class="text-start fw-5">Independence Day</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-5"></td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center "><img src="/build/images/flags/country_2.jpg" alt="flag"> Russia</span></td>
                                                        <td class="text-start fw-5">Moscow Stock Exchange</td>
                                                        <td class="text-start fw-5">National Day</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="tomorrow_calendar_tab" role="tabpanel" aria-labelledby="tomorrow-tab" tabindex="0">
                                        <p class="text-center">No holidays in this date range</p>
                                    </div>
