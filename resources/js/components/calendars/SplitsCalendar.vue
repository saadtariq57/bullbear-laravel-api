                                    ...
                                    <div class="tab-pane fade " id="yesterday_calendar_tab" role="tabpanel" aria-labelledby="yesterday-tab" tabindex="0">
                                        <div class=" overflow-auto market-table-wapper">
                                            <table class="table table-width border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-start">Jun 13, 2024</td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center"><img src="/build/images/flags/country_1.jpg" alt="flag">Naas Tech ADR (<a href="">NAAS</a>)</span></td>
                                                        <td class="text-end fw-5">1:20</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start"></td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center"><img src="/build/images/flags/country_1.jpg" alt="flag"> Velo3D (<a href="">VLD</a>)</span></td>
                                                        <td class="text-end fw-5">1:35</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start">Jun 12, 2024</td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center"><img src="/build/images/flags/country_1.jpg" alt="flag">Amphenol (<a href="">APH</a>)</span></td>
                                                        <td class="text-end fw-5">2:1</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class=" overflow-auto market-table-wapper">
                                            <table class="table table-width border">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-start">Jun 11, 2024</td>
                                                        <td class="text-start fw-5"><span class="flagCur d-flex gap-1 align-items-center"><img src="/build/images/flags/country_1.jpg" alt="flag">Canadian Natural (<a href="">CNQ</a>)</span></td>
                                                        <td class="text-end fw-5">2:1</td>
                                                    </tr>
                                                </tbody>
                                            </table>
