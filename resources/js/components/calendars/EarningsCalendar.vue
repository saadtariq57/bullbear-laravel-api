                                        ...
                                        <div class=" overflow-auto market-table-wapper">
                                            <table class="table table-width border">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="fw-5"><span class="flagCur d-flex gap-1 align-items-center"><img src="/build/images/flags/country_1.jpg" alt="flag"> Signet Jewelers (<a href="">SIG</a>)</span></td>
                                                        <td class="text-end Green pe-0">1.11</td>
                                                        <td class="text-start fw-5 ps-1">/  0.94</td>
                                                        <td class="text-end fw-5 Red pe-0">1.5B</td>
                                                        <td class="text-start fw-5 ps-1">/  1.51B</td>
                                                        <td class="text-end fw-5">4.14B</td>
                                                        <td class="text-center fw-5"><span class="marketClosed genToolTip oneliner reverseToolTip" data-tooltip="After market close"></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-5"><span class="flagCur d-flex gap-1 align-items-center"><img src="/build/images/flags/country_1.jpg" alt="flag"> Lovesac (<a href="">LOVE</a>)</span></td>
                                                        <td class="text-end Green pe-0">-0.83</td>
                                                        <td class="text-start fw-5 ps-1">/  -0.95</td>
                                                        <td class="text-end fw-5 Green pe-0">132.6M</td>
                                                        <td class="text-start fw-5 ps-1">/  128.08M</td>
                                                        <td class="text-end fw-5">404.90M</td>
                                                        <td class="text-center fw-5"><span class="marketOpen genToolTip oneliner reverseToolTip" data-tooltip="After market close"></span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
