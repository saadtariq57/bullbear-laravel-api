<template>
  ...
  <div class="mt-5 bg-white shadow-sm rounded">
    <div class="row g-4">
      <div class="col-4">
        <video width="100%" controls class="profile-videos">
          <source
            src="https://s3.us-east-1.wasabisys.com/rpdapp1/upload/videos/2023/06/ND7fGM14b61cGJpFkVdt_05_39aa96c122c110d6068f7f049fb091ed_video.mp4"
            type="video/mp4">
