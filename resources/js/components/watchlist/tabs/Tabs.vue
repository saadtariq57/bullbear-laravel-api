                                    ...
                                    <tr v-for="symbolData in watchlist.watchlist_symbols" :key="symbolData.id">
                                        ...
                                        <td class="gray lh-sm text-end" id="symbol-price">
                                            <div v-if="!symbolData.symbol.stats">
                                                <span style="margin-bottom:4px;display:block;width: 50px;text-align:right;"><Skeletor height="15"/></span>
                ...
                <DataTable class="display table min-w-800 fw-bold" id="listTable" :data="watchlist_symbols">
                    ...
                    <tbody>
                        <tr v-for="symbolData in selectedWatchlist.watchlist_symbols" :key="symbolData.id">
                            ...
                            <td>
                                <div
                                    :class="backgroundChangeClasses(symbolData)">
                            ...
                            <td class="text-end">{{ symbolData.symbol.stats.regularMarketVolume }} </td>
                            <td class="text-end">
                            ...
                            <td class="text-end">{{ symbolData.symbol.stats.regularMarketDayRange }}</td>
                        </tr>
                    </tbody>
                </DataTable>
            </div>
