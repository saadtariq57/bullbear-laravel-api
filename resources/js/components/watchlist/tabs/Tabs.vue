    ...
    <div class="container my-4">
        ...
        <div v-if="userData != null">
            ...
            <div class="d-flex mt-3" v-else>
                ...
                <a href="javascript:void(0)" class="watchlist-navlinks px-3" style="display:none;"><b>Stock
                        Screener</b></a>
            </div>
        </div>
                ...
                <div class="tab-pane fade show active" id="dashboard-tab-pane" role="tabpanel"
                    ...
                    <div class="row" v-show="watchlists">
                        <div class="col-lg-4 col-md-12 my-4" v-for="watchlist in watchlists">
                            <div
                                :class="watchlist.featured == 1 ? 'featuredWathclist watchlist-dashboard-container border p-3' : 'watchlist-dashboard-container border p-3'">
                                <h3 class="fs-18 cursor-pointer" @click="selectWatchlist(watchlist, 'userSelection')"><b>{{
                watchlist.title }}
                                    </b></h3>
                                <div class="table-responsive watchlist-dash-table">
                                    <table class="table stock-market-table1">
                                        ...
                                        <p v-if="watchlist.watchlist_symbols.length <= 0" class="p-3">This watchlist
                                            does not
                                            have any symbols.</p>
                ...
                <div class="tab-pane fade" id="include-tab-pane" role="tabpanel" aria-labelledby="include-tab"
                    ...
                    <div class="mt-4 table-responsive" v-if="selectedWatchlist">
                        <DataTable class="display table watchlist-new-table fw-bold" id="newsTable" :data="watchlist_symbols">
                            ...
                            <tbody>
                                <tr :key="symbolData.id" v-for="symbolData in selectedWatchlist.watchlist_symbols" class="position-relative" :class="symbolData.symbol.news.title != null ? 'table-news-row' : ''">
