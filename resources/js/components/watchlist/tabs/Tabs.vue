    ...
    <div class="tab-content" id="myTabContent">
                    ...
                    <div class="watchlist-dashboard-container border p-3">
                        ...
                        <div class="table-responsive">
                            <table class="table stock-market-table1 height-1024">
                                ...
                                <p v-if="watchlist.watchlist_symbols.length <= 0" class="p-3">This watchlist does not have any symbols.</p>
                                    ...
                                    <tr v-for="symbolData in watchlist.watchlist_symbols" :key="symbolData.id">
                                        ...
                                        <td class="gray lh-sm text-end" id="symbol-price">
                                            <div v-if="!symbolData.symbol.stats">
                                                ...
                                                <span style="width:50px"><Skeletor height="15"/></span>
                                            </div>
                                            <div v-else>
                                                ...
                                                <div :class="textChangeClasses(symbolData)">
                                                    ...
                                                    <span>{{ symbolData.symbol.stats.regularMarketChangePercent }}</span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <div class="tab-pane fade" id="content-tab-pane" role="tabpanel" aria-labelledby="content-tab"
            ...
            <div class="mt-4 table-responsive" v-if="selectedWatchlist">
                <DataTable class="display table min-w-800 fw-bold" id="listTable" :data="watchlist_symbols" :key="dataTableKey">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr v-for="symbolData in selectedWatchlist.watchlist_symbols" :key="symbolData.id">
                            <td>{{ symbolData.symbol.name }} <p class="small-para fw-bold mb-0">{{ symbolData.symbol.company_name }}
                                </p>
                            </td>
                            <td class="text-end">
                                <span v-if="!symbolData.symbol.stats">
                                    <Skeletor height="15"/></span>
                                <span v-else>
                            ...
                            <td>
                                <div :class="backgroundChangeClasses(symbolData)" v-if="symbolData.symbol.stats">
                                    {{ symbolData.symbol.stats.regularMarketChange }} <p class="mb-0 mt-1 text-white">{{ symbolData.symbol.stats.regularMarketChangePercent }}%</p>
                                </div>
                            </td>
                            <td class="text-end">
                                <span v-if="symbolData.symbol.stats">
                            ...
                            <td class="text-end">
                                ...
                                <meter class="w-100 position-relative"
                                    id="table-meter"
                                    ...
                                    :style="{ '--caret-position': calculateCaretPosition(symbolData) }" v-if="symbolData.symbol.stats">
                                    2 out of 10
                                </meter>
                            </td>
                            <td class="text-end">
