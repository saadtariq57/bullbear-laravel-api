<template>
    <div class="row">
        <div class="col-lg-8 px-3">
            <div>
                <h1 class="fs-3 border-bottom pb-2">Commodities</h1>
               </div>
            <div class="mt-4 overflow-auto market-table-wapper">
                <h2 class="fs-5 mb-2 fw-5">Performance Table</h2>
            ...
            <div>
                <h1 class="fs-3 border-bottom pb-2 mt-5">Real Time Commodities</h1>
               </div>
            <div class="mt-4 overflow-auto market-table-wapper">
                <h2 class="fs-5 mb-2 fw-5">Energy</h2>
                <table class="table table-width border">
                    <thead>
                        <tr>
                            <th class="fw-6">Sybmol</th>
            ...
            <div class="mt-4 overflow-auto market-table-wapper">
                <h2 class="fs-5 mb-2 fw-5">Metals</h2>
                <table class="table table-width border">
                    <thead>
                        <tr>
                            <th class="fw-6">Sybmol</th>
