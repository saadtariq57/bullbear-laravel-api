<template>
    <div class="row">
        <div class="col-lg-8">
            <div>
                <h1 class="fs-3 border-bottom pb-2">World and Sector Indices</h1>
            </div>
            <div class="mt-4 overflow-auto market-table-wapper">
                <h2 class="fs-4 fw-5"><i class="bi bi-arrow-right-short fs-4"></i> USA</h2>
            ...
            <div class="mt-4 overflow-auto market-table-wapper">
                <h2 class="fs-4 fw-5"><i class="bi bi-arrow-right-short fs-4"></i> Pakistan</h2>
                <table class="table table-width border">
                    <thead>
                        <tr>
                            <th class="fw-6">Sybmol</th>
