<template>
    <div class="row">
        <div class="col-lg-8">
            <div>
                <h1 class="fs-3 border-bottom pb-2">Single Currency Crosses</h1>
                <p class="mt-2">Interested in crossing the data of a particular currency? Select the currency of your
                    choice from the major currency crosses list below and find out how it is trading against other
                    currencies.</p>
            ...
            <div class="mt-4 overflow-auto market-table-wapper">
                <h2 class="fs-4 mt-2">Performance Table</h2>
                <table class="table table-width border">
                    <thead>
                        <tr>
                            <th class="fw-6">Sybmol</th>
