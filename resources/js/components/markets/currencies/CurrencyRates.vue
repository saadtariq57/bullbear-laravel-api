<template>
    <div class="row">
        <div class="col-lg-8">
            <div>
                <h1 class="fs-3 border-bottom pb-2">Real Time Major Forex Rates</h1>
                <p class="mt-2">Access live currency rates on all major currency crosses in an easy-to-read format.
                    Assess the bid, ask, open, high, low and currency rate changes</p>
            </div>
