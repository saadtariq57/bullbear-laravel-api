<template>
    <div class="row">
        <div class="col-lg-8 px-3">
            <div>
                <h1 class="fs-3 border-bottom pb-2">Real Time Commodity Futures Prices</h1>
                <p class="mt-2">The stock futures table displays real time, streaming CFDs rates of world indices
                    futures. In the table, you'll find the latest futures prices, as well as the daily high, low and the
                    change for each future contract.</p>
            </div>
