<template>
        <section class="MarketWatch mb-3 mt-5">
                <div class="container">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="MarketWatch-p">Need to know guide investor to the most important ,insightful items
                                required to chart a course ahead of each trading day</p>
                        </div>
                        <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="MarketWatch-p">A distributed ledger is the consensus of replicated, shared, and
                                synchronized digital data that is geographically spread (distributed) across many sites</p>
                        </div>
                        <div
                            class="d-flex pt-4 pt-lg-0 align-items-center justify-content-center justify-content-lg-start gap-5 switch-button">
                            <div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="MarketWatch-p">You can invest in Bitcoin directly by using one of the major
                                cryptocurrency exchanges, such as Coinbase or Binance.</p>
                        </div>
                        <div
                            class="d-flex pt-4 pt-lg-0 align-items-center justify-content-center justify-content-lg-start gap-5 switch-button">
                            <!-- <div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="MarketWatch-p">Welcome to MarketWatch's private Facebook community for advice on money
                                ethics and financial etiquette. The Moneyist (aka Quentin Fottrell) will lead</p>
                        </div>
                        <div
                            class="d-flex pt-4 pt-lg-0 align-items-center justify-content-center justify-content-lg-start gap-5 switch-button">
                            <div>
                    ...
                    <div class="d-flex justify-content-end py-4">
                        <button class="btn-scrollbar text-white justify-content-between align-items-center gap-2"
                            id="scroll_TopBtn" onclick="scrollToTopBtn()">Back To Top <span
                                class="fs-13">▲</span></button>
                    </div>
                </div>
            </section>
</template>