<template>
	...
	<div class="modal-body">
	  ...
	  <div class="mb-3">
	    ...
	    <div class="d-flex align-items-center">
	      ...
	      <label class="form-check-label mb-0" for="Radioanyone">Anyone</label>
	    ...
	    <div class="d-flex align-items-center">
	      ...
	      <label class="form-check-label mb-0" for="Radioconnectiononly">Followers only</label>
	  ...
	  <div class="mb-3">
	    ...
	    <div class="d-flex align-items-center">
	      ...
	      <label class="form-check-label mb-1" for="enableComments">Enable Comments</label>
	    ...
	    <div class="d-flex align-items-center">
	      ...
	      <label class="form-check-label mb-1" for="disableComments">Disable Comments</label>
    ...
    <div class="modal-footer">
      <button type="button" class="btn rounded-2 border-btn px-4" @click="emitBack">Back</button>
