                                    ...
                                    <form action="{{ route('admin.users.index') }}" method="GET">
                                        <div class="search-box me-2">
                                            <div class="position-relative">
                                                <input type="text" name="search" class="form-control border" placeholder="Search users..." value="{{ request()->query('search') }}">
                                    ...
                                    <tr>
                                        <th scope="col" style="width: 50px;">
                                            <div class="form-check font-size-16">
                                                <input type="checkbox" class="form-check-input" id="contactusercheck">
                                                <label class="form-check-label" for="contactusercheck"></label>
                                            </div>
                                        </th>
                                            ...
                                            <td>
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('admin.users.edit', $user) }}" class="px-2 text-primary">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <form action="{{route('admin.users.destroy', $user->id)}}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-danger delete-user" type="button" data-user-id="{{ $user->id }}">
