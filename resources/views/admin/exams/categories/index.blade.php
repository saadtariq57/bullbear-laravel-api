                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <div class="form-inline float-md-start mb-3">
                                <form action="{{ route('admin.exams.categories.index') }}" method="GET">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 float-end">
                                <a href="{{route('admin.exams.categories.create')}}" class="btn btn-primary">
                                        ...
                                        <td>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">
                                                    <a href="{{ route('admin.exams.categories.edit', $category) }}" class="px-2 text-primary">
                                                        <i class="ri-pencil-line font-size-18"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <form action="{{route('admin.exams.categories.destroy', $category->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
