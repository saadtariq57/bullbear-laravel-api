    ...
    <section class="container-fluid manage-watchlist py-80">
        <div class="container-sm px-5 pt-5 pb-3 mt-5 manage-watchlist-con">
            ...
            <div class="manage-watchlist-sidebar mt-3 mb-5 pb-5">
                ...
                <a href="#" class="border-start border-dark px-3 text-decoration-underline fw-bold">Add Symbol <svg
                        width="10" height="10" viewBox="0 0 8 8" fill="#fff" role="img" data-analytic-id="add-icon"
