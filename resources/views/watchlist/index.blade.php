        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex mt-3">
                    <a href="/manageWatchlist" class="watchlist-navlinks border-end pe-3 h-75"><b>Manage<i
                                class="bi bi-pencil-square icon-bold ms-1"></i></b></a>

                    <a href="/createwatchlist" class="watchlist-navlinks border-end px-3 h-75"><b>Create New <i
