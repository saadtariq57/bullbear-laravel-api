                    ...
                    <div class="widgets-slider mb-0">
                        <div class="d-flex justify-content-around align-items-center widgets-slider-card">
                            <div class="hero-card-wrapper">
                                ...
                                <div class="Green fs-14 fw-bolder text-start"><span>+645.92</span> <span>(+1.71%)</span>
                                </div>
                            </div>
        ...
        <div class="container-fluid hero-wrapper">
            <div class="row m-0">
                ...
                <div class="col-lg-5 hero-graph px-5">
                    ...
                    <img src="{{ URL::asset('build/images/hero-graph.png') }}" alt="Graph"
                ...
                <div class="col-12">
                    <div class="btn-flex mb-4 px-10">
                        ...
                        <div class="help-btn-all text-end ">
                            <a href="/ceo-interviews/" class="btn btn-primary fs-18 px-3 py-2"
                                aria-label="View All videos">View
                                ...
                                <div class="video-featured position-relative">
                                    <form action="">
                                        ...
                                        <div class="video-play-icon-small position-absolute">
                                            <a href=""><img src="{{ URL::asset('build/images/play-icon.png') }}" alt=""
                                                    width="50"></a>
                                        </div>
                                    </form>
        ...
        <div class="container">
            ...
            <div class="row key-features gy-4">
                <div class="col-xl-3 col-lg-6 col-12">
                    <div class="feature text-center h-100 px-1">
                        <div class="d-flex flex-column">
                            <img src="https://s3.wasabisys.com/rpdapp1/upload/photos/2023/img/richtv-personalized.png"
                                width="40" alt="icon" class="d-block mb-2 mx-auto">
                            <h3 class="fs-18 fw-bolder lh-base m-0">Personalized Watchlists</h3>
                            <p class="">Tailor your trading journey! Create and customize watchlists to track stocks
                                that
                ...
                <div class="col-xl-3 col-lg-6 col-12">
                    <div class="feature text-center h-100 px-1">
                        <div class="d-flex flex-column">
                            <img src="https://s3.wasabisys.com/rpdapp1/upload/photos/2023/img/rictv-expert.png"
                                width="40" alt="icon" class="d-block mb-2 mx-auto">
                            <h3 class="fs-18 fw-bolder lh-base m-0">Expert Top Picks</h3>
                            <p class="">Navigate the market with confidence! Our seasoned experts handpick stocks with
                                high
                ...
                <div class="col-xl-3 col-lg-6 col-12">
                    <div class="feature text-center h-100 px-1">
                        <div class="d-flex flex-column">
                            <img src="https://s3.wasabisys.com/rpdapp1/upload/photos/2023/img/richtv-groupchat.png"
                                width="40" alt="icon" class="d-block mb-2 mx-auto">
                            <h3 class="fs-18 fw-bolder lh-base m-0">Vibrant Group Chats</h3>
                            <p class="">Connect, discuss, and strategize! Join our dynamic chat rooms where traders
                                share
                ...
                <div class="col-xl-3 col-lg-6 col-12">
                    <div class="feature text-center h-100 px-1">
                        <div class="d-flex flex-column">
                            <img src="https://s3.wasabisys.com/rpdapp1/upload/photos/2023/img/richtv-training.png"
                                width="40" alt="icon" class="d-block mb-2 mx-auto">
                            <h3 class="fs-18 fw-bolder lh-base m-0">Interactive Live Trainings</h3>
                            <p class="">Learn from the best! Attend live sessions with industry professionals. Enhance
                                your
                        ...
                        <div class="stock-table-data position-relative ">
                            <div class="table-responsive">
                                ...
                                <table class="table stock-market-table1 m-0">
                                        ...
                                        <tr class="position-relative btn-row">
                                            <td>
                                                <div class="add-watchlist-btn position-absolute">
                                                    <a href="" class="btn btn-primary fs-14 px-3" type="button"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#add-watchlist-popup">Watchlist</a>
                                                </div>
                                                <a href="/stock-quote/ROKU:NMS"
                                                    class="gray d-flex align-items-center gap-2"
                                                    aria-label="Stock Quote">
                                                    <img src="{{ URL::asset('build/images/brands/cryptocurrency_btc.png') }}"
                                        ...
                                        <tr class="position-relative btn-row">
                                            <td>
                                                <div class="add-watchlist-btn position-absolute">
                                                    <a href="" class="btn btn-primary fs-14 px-3" type="button"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#login-popup">Watchlist</a>
                                                </div>
                                                <a href="/stock-quote/ROKU:NMS"
                                                    class="gray d-flex align-items-center gap-2"
                                                    aria-label="Stock Quote">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" class="update-date fs-13 text-center">Last Updated Oct 19,
                                                2023</td>
                                        </tr>
                                    </tfoot>
                                </table>
        ...
        <div class="modal fade" id="login-popup" tabindex="-1" aria-labelledby="login-popupLabel" aria-hidden="true">
            <div class="modal-dialog login-popup-dialog modal-dialog-centered">
                <div class="modal-content position-relative">
                    <button type="button" class="btn-close position-absolute login-popup-closebtn"
                                ...
                                <form>
                                    ...
                                    <div class="d-sm-flex justify-content-between mt-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="exampleCheck1">Remember this
                                                device</label>
                                        </div>
                                        <div>
                    ...
                    <div class="modal-body">
                        <form action="" class="px-4">
                            <div class="form-check p-3">
                                <input class="form-check-input" type="radio" name="watchlistRadioDefault"
                                    id="watchlistRadioDefault1">
                            ...
                            <div class="market-news border-bottom border-1 border-grey">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="stock-post-content">
                                        <h4 class="lh-0 mb-0"><a href="#" aria-label="tittle">CrowdStrike (CRWD) and New
                                                Oriental
                                                Educ...</a></h4>
                        ...
                        <a href="" class="guide-card-hover d-block">
                            <div class="guide-card-wrapper"
                                ...
                                <div class="guide-content position-relative">
                                    ...
                                    <P class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit
                                        dolorum quasi
            ...
            <div class="testimonial-slider wide-slider">
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-info d-flex gap-3 align-items-center">
                        <i class="bi bi-person-fill text-white testimonial-info-img d-flex align-items-center justify-content-center"
                            style="background-color: rgb(110, 46, 246);"></i>
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-info d-flex gap-3 align-items-center">
                        <i class="bi bi-person-fill text-white testimonial-info-img d-flex align-items-center justify-content-center"
                            style="background-color: rgb(76, 214, 151);"></i>
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-info d-flex gap-3 align-items-center">
                        <i class="bi bi-person-fill text-white testimonial-info-img d-flex align-items-center justify-content-center"
                            style="background-color: rgb(250, 50, 90);"></i>
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-info d-flex gap-3 align-items-center">
                        <i class="bi bi-person-fill text-white testimonial-info-img d-flex align-items-center justify-content-center"
                            style="background-color: rgb(0, 204, 102);"></i>
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-info d-flex gap-3 align-items-center">
                        <i class="bi bi-person-fill text-white testimonial-info-img d-flex align-items-center justify-content-center"
                            style="background-color: rgb(102, 153, 255);"></i>
                        <div>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-info d-flex gap-3 align-items-center">
                        <i class="bi bi-person-fill text-white testimonial-info-img d-flex align-items-center justify-content-center"
                            style="background-color: rgb(203, 203, 203);"></i>
                        <div>
                    ...
                    <form class="mt-4">
                        <div class="form-group d-flex flex-wrap  gap-3">
                            <div class="flex-fill position-relative">
                                <input type="email"
                                    class="form-control form-control-lg px-3 py-3 fs-6 newsletter-input border"
                                    id="exampleFormControlInput1" placeholder="Enter your Email">
                                <button type="submit"
                                    class="btn btn-primary fw-5 newsletter-btn position-absolute">Submit</button>
                            </div>
                        </div>
                        ...
                        <div class="risk-heading">
                            ...
                            <div>
                                ...
                                <div class="slide-up-down">
                                    <p style="display: none;" class="fs-18 lh-base">Stock market investing is inherently
                                        risky. Rich TV is
                                        not
